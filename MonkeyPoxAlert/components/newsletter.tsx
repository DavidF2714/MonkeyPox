...
import monkeypoxImage from '../assets/logo.png'; // Ensure this path is correct

const SymptomForm = () => {
  return (
    <form style={{color:'black', fontFamily: "'Architects Daughter', sans-serif"}} className="w-full max-w-xl mx-auto  bg-white rounded shadow-md">
      {/* <h2 className="text-2xl font-bold mb-4 pb-5 text-center">Mpox Symptom Self-Assessment Form</h2>
       */}
      ...
      <div className="flex flex-col space-y-4 p-6">
        ...
        <div className="flex flex-row justify-center align-center w-full max-w-lg">
          ...
          <div className="flex flex-wrap justify-center space-x-4">
            <label className="flex items-center">
              <input type="radio" name="fever" value="no" className="mr-2" />
              lymphaden
            </label>
            <label className="flex items-center">
              <input type="radio" name="fever" value="yes" className="mr-2" />
              Fever
            </label>
            <label className="flex items-center">
              <input type="radio" name="fever" value="no" className="mr-2" />
        ...
        <div className="flex flex-row justify-around align-center w-full max-w-lg">
          ...
          <div className="flex justify-center space-x-4">
            <label className="flex items-center">
              <input type="radio" name="yes" value="yes" className="mr-2" />
              Yes
            </label>
            <label className="flex items-center">
              <input type="radio" name="yes" value="no" className="mr-2" />
              No
            </label>
        ...
        <div className="flex flex-row justify-around align-center w-full max-w-lg">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <label className="flex items-center">
              <input type="radio" name="no" value="no" className="mr-2" />
              No
            </label>
